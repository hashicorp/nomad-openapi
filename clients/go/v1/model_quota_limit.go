...
type QuotaLimit struct {
	...
	RegionLimit NullableResources `json:"RegionLimit,omitempty"`
}
...
// GetRegionLimit returns the RegionLimit field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *QuotaLimit) GetRegionLimit() Resources {
	if o == nil || o.RegionLimit.Get() == nil {
		var ret Resources
		return ret
	}
	return *o.RegionLimit.Get()
}
...
// SetRegionLimit gets a reference to the given NullableResources and assigns it to the RegionLimit field.
func (o *QuotaLimit) SetRegionLimit(v Resources) {
	o.RegionLimit.Set(&v)
}
// SetRegionLimitNil sets the value for RegionLimit to be an explicit nil
func (o *QuotaLimit) SetRegionLimitNil() {
	o.RegionLimit.Set(nil)
}
...
func (o QuotaLimit) MarshalJSON() ([]byte, error) {
	...
	if o.RegionLimit.IsSet() {
		toSerialize["RegionLimit"] = o.RegionLimit.Get()
	}
