...
func (r ApiGetEvaluationRequest) Execute() (Evaluation, *_nethttp.Response, error) {
 ...
 */
func (a *EvaluationsApiService) GetEvaluation(ctx _context.Context, evalID string) ApiGetEvaluationRequest {
	return ApiGetEvaluationRequest{
		ApiService: a,
		ctx: ctx,
		evalID: evalID,
 ...
 * @return Evaluation
 */
func (a *EvaluationsApiService) GetEvaluationExecute(r ApiGetEvaluationRequest) (Evaluation, *_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"evalID"+"}", _neturl.PathEscape(parameterToString(r.evalID, "")), -1)
...
func (r ApiGetEvaluationAllocationsRequest) Execute() ([]AllocationListStub, *_nethttp.Response, error) {
 ...
 */
func (a *EvaluationsApiService) GetEvaluationAllocationsExecute(r ApiGetEvaluationAllocationsRequest) ([]AllocationListStub, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 */
func (a *EvaluationsApiService) GetEvaluations(ctx _context.Context) ApiGetEvaluationsRequest {
	return ApiGetEvaluationsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return []Evaluation
 */
func (a *EvaluationsApiService) GetEvaluationsExecute(r ApiGetEvaluationsRequest) ([]Evaluation, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
