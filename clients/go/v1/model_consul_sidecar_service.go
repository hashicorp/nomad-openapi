...
type ConsulSidecarService struct {
	...
	Proxy NullableConsulProxy `json:"Proxy,omitempty"`
...
// SetProxy gets a reference to the given NullableConsulProxy and assigns it to the Proxy field.
func (o *ConsulSidecarService) SetProxy(v ConsulProxy) {
	o.Proxy.Set(&v)
}
// SetProxyNil sets the value for Proxy to be an explicit nil
func (o *ConsulSidecarService) SetProxyNil() {
	o.Proxy.Set(nil)
}
