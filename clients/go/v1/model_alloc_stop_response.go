...
type NullableAllocStopResponse struct {
	value *AllocStopResponse
	isSet bool
}

func (v NullableAllocStopResponse) Get() *AllocStopResponse {
	return v.value
}

func (v *NullableAllocStopResponse) Set(val *AllocStopResponse) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAllocStopResponse(val *AllocStopResponse) *NullableAllocStopResponse {
	return &NullableAllocStopResponse{value: val, isSet: true}
}
