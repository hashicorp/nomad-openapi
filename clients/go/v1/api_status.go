...
func (r ApiGetStatusLeaderRequest) Execute() (string, *_nethttp.Response, error) {
 ...
 */
func (a *StatusApiService) GetStatusLeader(ctx _context.Context) ApiGetStatusLeaderRequest {
	return ApiGetStatusLeaderRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (r ApiGetStatusPeersRequest) Execute() ([]string, *_nethttp.Response, error) {
 ...
 */
func (a *StatusApiService) GetStatusPeers(ctx _context.Context) ApiGetStatusPeersRequest {
	return ApiGetStatusPeersRequest{
		ApiService: a,
		ctx: ctx,
	}
