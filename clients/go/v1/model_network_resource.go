...
type NetworkResource struct {
	...
	DNS NullableDNSConfig `json:"DNS,omitempty"`
...
// SetDNS gets a reference to the given NullableDNSConfig and assigns it to the DNS field.
func (o *NetworkResource) SetDNS(v DNSConfig) {
	o.DNS.Set(&v)
}
// SetDNSNil sets the value for DNS to be an explicit nil
func (o *NetworkResource) SetDNSNil() {
	o.DNS.Set(nil)
}
