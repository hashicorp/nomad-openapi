...
// SetCapabilities gets a reference to the given NullableNamespaceCapabilities and assigns it to the Capabilities field.
func (o *Namespace) SetCapabilities(v NamespaceCapabilities) {
	o.Capabilities.Set(&v)
}
// SetCapabilitiesNil sets the value for Capabilities to be an explicit nil
func (o *Namespace) SetCapabilitiesNil() {
