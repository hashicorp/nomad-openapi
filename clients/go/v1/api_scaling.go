...
func (r ApiGetScalingPoliciesRequest) Execute() ([]ScalingPolicyListStub, *_nethttp.Response, error) {
 ...
 */
func (a *ScalingApiService) GetScalingPolicies(ctx _context.Context) ApiGetScalingPoliciesRequest {
	return ApiGetScalingPoliciesRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *ScalingApiService) GetScalingPoliciesExecute(r ApiGetScalingPoliciesRequest) ([]ScalingPolicyListStub, *_nethttp.Response, error) {
	var (
...
func (r ApiGetScalingPolicyRequest) Execute() (ScalingPolicy, *_nethttp.Response, error) {
 ...
 */
func (a *ScalingApiService) GetScalingPolicyExecute(r ApiGetScalingPolicyRequest) (ScalingPolicy, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
