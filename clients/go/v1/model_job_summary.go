...
type JobSummary struct {
	Children NullableJobChildrenSummary `json:"Children,omitempty"`
...
// SetChildren gets a reference to the given NullableJobChildrenSummary and assigns it to the Children field.
func (o *JobSummary) SetChildren(v JobChildrenSummary) {
	o.Children.Set(&v)
}
// SetChildrenNil sets the value for Children to be an explicit nil
func (o *JobSummary) SetChildrenNil() {
	o.Children.Set(nil)
}
