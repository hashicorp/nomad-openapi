...
*/
func (a *RegionsApiService) GetRegions(ctx context.Context) ApiGetRegionsRequest {
	return ApiGetRegionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []string
func (a *RegionsApiService) GetRegionsExecute(r ApiGetRegionsRequest) ([]string, *http.Response, error) {
	var (
