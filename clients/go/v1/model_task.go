...
type Task struct {
	...
	CSIPluginConfig NullableTaskCSIPluginConfig `json:"CSIPluginConfig,omitempty"`
	Config map[string]interface{} `json:"Config,omitempty"`
	Constraints []Constraint `json:"Constraints,omitempty"`
	DispatchPayload NullableDispatchPayloadConfig `json:"DispatchPayload,omitempty"`
	...
	Lifecycle NullableTaskLifecycle `json:"Lifecycle,omitempty"`
	...
	Vault NullableVault `json:"Vault,omitempty"`
...
// GetCSIPluginConfig returns the CSIPluginConfig field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Task) GetCSIPluginConfig() TaskCSIPluginConfig {
	if o == nil || o.CSIPluginConfig.Get() == nil {
		var ret TaskCSIPluginConfig
		return ret
	}
	return *o.CSIPluginConfig.Get()
}
...
func (o *Task) HasCSIPluginConfig() bool {
	if o != nil && o.CSIPluginConfig.IsSet() {
		return true
	}
...
// SetCSIPluginConfig gets a reference to the given NullableTaskCSIPluginConfig and assigns it to the CSIPluginConfig field.
func (o *Task) SetCSIPluginConfig(v TaskCSIPluginConfig) {
	o.CSIPluginConfig.Set(&v)
}
// SetCSIPluginConfigNil sets the value for CSIPluginConfig to be an explicit nil
func (o *Task) SetCSIPluginConfigNil() {
	o.CSIPluginConfig.Set(nil)
}
...
// GetDispatchPayload returns the DispatchPayload field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Task) GetDispatchPayload() DispatchPayloadConfig {
	if o == nil || o.DispatchPayload.Get() == nil {
		var ret DispatchPayloadConfig
		return ret
	}
	return *o.DispatchPayload.Get()
}
...
func (o *Task) HasDispatchPayload() bool {
	if o != nil && o.DispatchPayload.IsSet() {
		return true
	}
...
// SetDispatchPayload gets a reference to the given NullableDispatchPayloadConfig and assigns it to the DispatchPayload field.
func (o *Task) SetDispatchPayload(v DispatchPayloadConfig) {
	o.DispatchPayload.Set(&v)
}
// SetDispatchPayloadNil sets the value for DispatchPayload to be an explicit nil
func (o *Task) SetDispatchPayloadNil() {
	o.DispatchPayload.Set(nil)
}
...
// SetLifecycle gets a reference to the given NullableTaskLifecycle and assigns it to the Lifecycle field.
func (o *Task) SetLifecycle(v TaskLifecycle) {
	o.Lifecycle.Set(&v)
}
// SetLifecycleNil sets the value for Lifecycle to be an explicit nil
func (o *Task) SetLifecycleNil() {
	o.Lifecycle.Set(nil)
}
...
// SetVault gets a reference to the given NullableVault and assigns it to the Vault field.
func (o *Task) SetVault(v Vault) {
	o.Vault.Set(&v)
}
// SetVaultNil sets the value for Vault to be an explicit nil
func (o *Task) SetVaultNil() {
	o.Vault.Set(nil)
}
...
func (o Task) MarshalJSON() ([]byte, error) {
	...
	if o.CSIPluginConfig.IsSet() {
		toSerialize["CSIPluginConfig"] = o.CSIPluginConfig.Get()
	}
	if o.Config != nil {
	...
	if o.DispatchPayload.IsSet() {
		toSerialize["DispatchPayload"] = o.DispatchPayload.Get()
	}
	if o.Driver != nil {
