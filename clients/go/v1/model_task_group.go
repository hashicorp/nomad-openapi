...
type TaskGroup struct {
	...
	Consul NullableConsul `json:"Consul,omitempty"`
	...
	Scaling NullableScalingPolicy `json:"Scaling,omitempty"`
...
// GetConsul returns the Consul field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TaskGroup) GetConsul() Consul {
	if o == nil || o.Consul.Get() == nil {
		var ret Consul
		return ret
	}
	return *o.Consul.Get()
...
// SetConsul gets a reference to the given NullableConsul and assigns it to the Consul field.
func (o *TaskGroup) SetConsul(v Consul) {
	o.Consul.Set(&v)
}
// SetConsulNil sets the value for Consul to be an explicit nil
func (o *TaskGroup) SetConsulNil() {
	o.Consul.Set(nil)
}
...
func (o *TaskGroup) GetScaling() ScalingPolicy {
	if o == nil || o.Scaling.Get() == nil {
		var ret ScalingPolicy
		return ret
	}
	return *o.Scaling.Get()
}
...
// SetScaling gets a reference to the given NullableScalingPolicy and assigns it to the Scaling field.
...
func (o TaskGroup) MarshalJSON() ([]byte, error) {
	...
	if o.Consul.IsSet() {
		toSerialize["Consul"] = o.Consul.Get()
	}
	if o.Count != nil {
	...
	if o.Scaling.IsSet() {
		toSerialize["Scaling"] = o.Scaling.Get()
	}
	if o.Services != nil {
