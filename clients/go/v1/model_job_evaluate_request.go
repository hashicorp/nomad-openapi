...
type JobEvaluateRequest struct {
	EvalOptions NullableEvalOptions `json:"EvalOptions,omitempty"`
...
// GetEvalOptions returns the EvalOptions field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *JobEvaluateRequest) GetEvalOptions() EvalOptions {
	if o == nil || o.EvalOptions.Get() == nil {
		var ret EvalOptions
		return ret
	}
	return *o.EvalOptions.Get()
}
...
// SetEvalOptions gets a reference to the given NullableEvalOptions and assigns it to the EvalOptions field.
...
func (o *JobEvaluateRequest) SetEvalOptionsNil() {
	o.EvalOptions.Set(nil)
}
...
func (o JobEvaluateRequest) MarshalJSON() ([]byte, error) {
	...
	if o.EvalOptions.IsSet() {
		toSerialize["EvalOptions"] = o.EvalOptions.Get()
	}
	if o.JobID != nil {
