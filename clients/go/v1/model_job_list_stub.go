...
type JobListStub struct {
	...
	JobSummary NullableJobSummary `json:"JobSummary,omitempty"`
...
// SetJobSummary gets a reference to the given NullableJobSummary and assigns it to the JobSummary field.
func (o *JobListStub) SetJobSummary(v JobSummary) {
	o.JobSummary.Set(&v)
}
// SetJobSummaryNil sets the value for JobSummary to be an explicit nil
func (o *JobListStub) SetJobSummaryNil() {
