...
type Job struct {
	...
	Multiregion NullableMultiregion `json:"Multiregion,omitempty"`
	Name *string `json:"Name,omitempty"`
	Namespace *string `json:"Namespace,omitempty"`
	NomadTokenID *string `json:"NomadTokenID,omitempty"`
	ParameterizedJob NullableParameterizedJobConfig `json:"ParameterizedJob,omitempty"`
...
// GetMultiregion returns the Multiregion field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Job) GetMultiregion() Multiregion {
	if o == nil || o.Multiregion.Get() == nil {
		var ret Multiregion
		return ret
	}
	return *o.Multiregion.Get()
}
...
// SetMultiregion gets a reference to the given NullableMultiregion and assigns it to the Multiregion field.
func (o *Job) SetMultiregion(v Multiregion) {
	o.Multiregion.Set(&v)
}
// SetMultiregionNil sets the value for Multiregion to be an explicit nil
func (o *Job) SetMultiregionNil() {
	o.Multiregion.Set(nil)
}
...
// GetParameterizedJob returns the ParameterizedJob field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *Job) GetParameterizedJob() ParameterizedJobConfig {
	if o == nil || o.ParameterizedJob.Get() == nil {
		var ret ParameterizedJobConfig
		return ret
	}
	return *o.ParameterizedJob.Get()
}
...
func (o *Job) HasParameterizedJob() bool {
	if o != nil && o.ParameterizedJob.IsSet() {
		return true
	}
...
// SetParameterizedJob gets a reference to the given NullableParameterizedJobConfig and assigns it to the ParameterizedJob field.
func (o *Job) SetParameterizedJob(v ParameterizedJobConfig) {
	o.ParameterizedJob.Set(&v)
}
// SetParameterizedJobNil sets the value for ParameterizedJob to be an explicit nil
func (o *Job) SetParameterizedJobNil() {
	o.ParameterizedJob.Set(nil)
}
...
func (o Job) MarshalJSON() ([]byte, error) {
	...
	if o.Multiregion.IsSet() {
		toSerialize["Multiregion"] = o.Multiregion.Get()
	}
	if o.Name != nil {
	...
	if o.ParameterizedJob.IsSet() {
		toSerialize["ParameterizedJob"] = o.ParameterizedJob.Get()
	}
	if o.ParentID != nil {
