    ...
    def __init__(self, api_client=None):
        ...
        self.get_allocation = _Endpoint(
            settings={
                ...
                'endpoint_path': '/allocation/{allocationID}',
        ...
        def __stop_allocation(
            self,
            allocation_id,
            **kwargs
        ):
            """stop_allocation  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.stop_allocation(allocation_id, async_req=True)
            >>> result = thread.get()
        ...
        self.stop_allocation = _Endpoint(
            settings={
                'response_type': (AllocStopResponse,),
                'auth': [
                    'X-Nomad-Token'
                ],
                'endpoint_path': '/allocation/{allocationID}/stop',
                'operation_id': 'stop_allocation',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
