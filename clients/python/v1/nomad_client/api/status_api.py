...
class StatusApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_status_leader(
            self,
            **kwargs
        ):
            """get_status_leader  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_status_leader(async_req=True)
            >>> result = thread.get()
        ...
        self.get_status_leader = _Endpoint(
            settings={
                'response_type': (str,),
                'auth': [
                    'X-Nomad-Token'
                ],
                'endpoint_path': '/status/leader',
                'operation_id': 'get_status_leader',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            callable=__get_status_leader
        )

        def __get_status_peers(
            self,
            **kwargs
        ):
            """get_status_peers  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.get_status_peers(async_req=True)
            >>> result = thread.get()
        ...
        self.get_status_peers = _Endpoint(
            settings={
                'response_type': ([str],),
                'auth': [
                    'X-Nomad-Token'
                ],
                'endpoint_path': '/status/peers',
                'operation_id': 'get_status_peers',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
