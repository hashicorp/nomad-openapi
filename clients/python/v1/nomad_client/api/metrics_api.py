...
class MetricsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_metrics_summary_endpoint = _Endpoint(
            settings={
                'response_type': (MetricsSummary,),
                'auth': [
                    'X-Nomad-Token'
                ],
    ...
    def get_metrics_summary(
        ...
        **kwargs
        ...
        return self.get_metrics_summary_endpoint.call_with_http_info(**kwargs)
