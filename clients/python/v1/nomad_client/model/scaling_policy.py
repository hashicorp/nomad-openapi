...
class ScalingPolicy(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'policy': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
            'target': ({str: (str,)},),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            policy ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
            target ({str: (str,)}): [optional]  # noqa: E501
