...
pub async fn get_allocation(configuration: &configuration::Configuration, allocation_id: &str, region: Option<&str>, namespace: Option<&str>, index: Option<i32>, wait: Option<&str>, stale: Option<&str>, prefix: Option<&str>, x_nomad_token: Option<&str>, per_page: Option<i32>, next_token: Option<&str>) -> Result<crate::models::Allocation, Error<GetAllocationError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/allocation/{allocationID}", configuration.base_path, allocationID=crate::apis::urlencode(allocation_id));
...
pub async fn stop_allocation(configuration: &configuration::Configuration, allocation_id: &str, region: Option<&str>, namespace: Option<&str>, x_nomad_token: Option<&str>, idempotency_token: Option<&str>) -> Result<crate::models::AllocStopResponse, Error<StopAllocationError>> {

    let local_var_client = &configuration.client;

    let local_var_uri_str = format!("{}/allocation/{allocationID}/stop", configuration.base_path, allocationID=crate::apis::urlencode(allocation_id));
