...
pub trait SearchApi {
    fn get_fuzzy_search(&self, fuzzy_search_request: Option<crate::models::FuzzySearchRequest>, region: Option<&str>, namespace: Option<&str>, index: Option<i32>, wait: Option<&str>, stale: Option<&str>, prefix: Option<&str>, x_nomad_token: Option<&str>, per_page: Option<i32>, next_token: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::FuzzySearchResponse, Error>>>>;
    fn get_search(&self, search_request: Option<crate::models::SearchRequest>, region: Option<&str>, namespace: Option<&str>, index: Option<i32>, wait: Option<&str>, stale: Option<&str>, prefix: Option<&str>, x_nomad_token: Option<&str>, per_page: Option<i32>, next_token: Option<&str>) -> Pin<Box<dyn Future<Output = Result<crate::models::SearchResponse, Error>>>>;
}
