...
pub trait OperatorApi {
    ...
    fn get_operator_raft_configuration(&self, region: Option<&str>, namespace: Option<&str>, index: Option<i32>, wait: Option<&str>, stale: Option<&str>, prefix: Option<&str>, x_nomad_token: Option<&str>, per_page: Option<i32>, next_token: Option<&str>) -> Box<dyn Future<Item = Vec<crate::models::RaftConfigurationResponse>, Error = Error<serde_json::Value>>>;
