...
```sh
pip install git+https://github.com/hashicorp/nomad-openapi/clients/ruby/v1.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/hashicorp/nomad-openapi/clients/ruby/v1.git`)
