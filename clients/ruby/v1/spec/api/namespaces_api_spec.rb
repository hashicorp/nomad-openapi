...
# Unit tests for NomadClient::NamespacesApi
...
describe 'NamespacesApi' do
  ...
  describe 'test an instance of NamespacesApi' do
    it 'should create an instance of NamespacesApi' do
      expect(@api_instance).to be_instance_of(NomadClient::NamespacesApi)
    end
  end
  ...
  # @param namespace_name The namespace identifier.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :region Filters results based on the specified region.
  # @option opts [String] :namespace Filters results based on the specified namespace.
  # @option opts [String] :x_nomad_token A Nomad ACL token.
  ...
  # @return [Namespace]
  describe 'get_namespace test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  # @option opts [String] :idempotency_token Can be used to ensure operations are only run once.
  # @return [nil]
  describe 'post_namespace test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
