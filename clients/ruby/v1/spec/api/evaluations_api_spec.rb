...
# Unit tests for NomadClient::EvaluationsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EvaluationsApi' do
  before do
  ...
  describe 'test an instance of EvaluationsApi' do
    it 'should create an instance of EvaluationsApi' do
      expect(@api_instance).to be_instance_of(NomadClient::EvaluationsApi)
    end
  end

  # unit tests for get_evaluation
  ...
  # @return [Evaluation]
  describe 'get_evaluation test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for get_evaluation_allocations
  # @param eval_id Evaluation ID.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :region Filters results based on the specified region.
  # @option opts [String] :namespace Filters results based on the specified namespace.
  ...
  describe 'get_evaluation_allocations test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
