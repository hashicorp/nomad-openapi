...
module NomadClient
  class NamespacesApi
    ...
    def post_namespace_with_http_info(namespace_name, namespace2, opts = {})
      ...
      if @api_client.config.client_side_validation && namespace2.nil?
        fail ArgumentError, "Missing the required parameter 'namespace2' when calling NamespacesApi.post_namespace"
      end
      # resource path
      local_var_path = '/namespace/{namespaceName}'.sub('{' + 'namespaceName' + '}', CGI.escape(namespace_name.to_s))
