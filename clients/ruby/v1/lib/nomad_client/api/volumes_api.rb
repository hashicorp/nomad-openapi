...
module NomadClient
  class VolumesApi
    ...
    def create_volume_with_http_info(volume_id, action, csi_volume_create_request, opts = {})
      ...
      # verify the required parameter 'csi_volume_create_request' is set
      if @api_client.config.client_side_validation && csi_volume_create_request.nil?
        fail ArgumentError, "Missing the required parameter 'csi_volume_create_request' when calling VolumesApi.create_volume"
      end
      # resource path
    ...
    def post_snapshot_with_http_info(csi_snapshot_create_request, opts = {})
      ...
      # verify the required parameter 'csi_snapshot_create_request' is set
      if @api_client.config.client_side_validation && csi_snapshot_create_request.nil?
        fail ArgumentError, "Missing the required parameter 'csi_snapshot_create_request' when calling VolumesApi.post_snapshot"
      end
      # resource path
      local_var_path = '/volumes/snapshot'
    ...
    def post_volume_with_http_info(csi_volume_register_request, opts = {})
      ...
      # verify the required parameter 'csi_volume_register_request' is set
      if @api_client.config.client_side_validation && csi_volume_register_request.nil?
        fail ArgumentError, "Missing the required parameter 'csi_volume_register_request' when calling VolumesApi.post_volume"
      end
      # resource path
      local_var_path = '/volumes'
    ...
    def post_volume_registration_with_http_info(volume_id, csi_volume_register_request, opts = {})
      ...
      # verify the required parameter 'csi_volume_register_request' is set
      if @api_client.config.client_side_validation && csi_volume_register_request.nil?
        fail ArgumentError, "Missing the required parameter 'csi_volume_register_request' when calling VolumesApi.post_volume_registration"
      end
      # resource path
      local_var_path = '/volume/csi/{volumeId}'.sub('{' + 'volumeId' + '}', CGI.escape(volume_id.to_s))
