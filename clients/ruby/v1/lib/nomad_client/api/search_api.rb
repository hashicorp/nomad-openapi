...
module NomadClient
  class SearchApi
    ...
    def get_fuzzy_search_with_http_info(fuzzy_search_request, opts = {})
      ...
      # verify the required parameter 'fuzzy_search_request' is set
      if @api_client.config.client_side_validation && fuzzy_search_request.nil?
        fail ArgumentError, "Missing the required parameter 'fuzzy_search_request' when calling SearchApi.get_fuzzy_search"
      end
      # resource path
    ...
    def get_search_with_http_info(search_request, opts = {})
      ...
      if @api_client.config.client_side_validation && search_request.nil?
        fail ArgumentError, "Missing the required parameter 'search_request' when calling SearchApi.get_search"
      end
      # resource path
