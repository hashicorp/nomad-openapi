...
module NomadClient
  class StatusApi
    ...
    # @return [String]
    def get_status_leader(opts = {})
      data, _status_code, _headers = get_status_leader_with_http_info(opts)
      data
    end
    ...
    def get_status_leader_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StatusApi.get_status_leader ...'
      end
      # resource path
      local_var_path = '/status/leader'
      ...
      new_options = opts.merge(
        :operation => :"StatusApi.get_status_leader",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StatusApi#get_status_leader\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :next_token Indicates where to start paging for queries that support pagination.
    # @return [Array<String>]
    def get_status_peers(opts = {})
      data, _status_code, _headers = get_status_peers_with_http_info(opts)
      data
    end
    ...
    def get_status_peers_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: StatusApi.get_status_peers ...'
      end
      # resource path
      local_var_path = '/status/peers'
      ...
      new_options = opts.merge(
        :operation => :"StatusApi.get_status_peers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: StatusApi#get_status_peers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
