...
module NomadClient
  class JobPlanResponse
    ...
    attr_accessor :next_periodic_launch
    ...
    def self.attribute_map
      {
        ...
        :'created_evals' => :'CreatedEvals',
        :'diff' => :'Diff',
        :'failed_tg_allocs' => :'FailedTGAllocs',
        :'job_modify_index' => :'JobModifyIndex',
        :'next_periodic_launch' => :'NextPeriodicLaunch',
        :'warnings' => :'Warnings'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NomadClient::JobPlanResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NomadClient::JobPlanResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'created_evals')
        if (value = attributes[:'created_evals']).is_a?(Array)
          self.created_evals = value
        end
      end
      ...
      if attributes.key?(:'next_periodic_launch')
        self.next_periodic_launch = attributes[:'next_periodic_launch']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          created_evals == o.created_evals &&
          diff == o.diff &&
          failed_tg_allocs == o.failed_tg_allocs &&
          job_modify_index == o.job_modify_index &&
          next_periodic_launch == o.next_periodic_launch &&
          warnings == o.warnings
    end
    ...
    def hash
      [annotations, created_evals, diff, failed_tg_allocs, job_modify_index, next_periodic_launch, warnings].hash
    end
