...
module NomadClient
  class OneTimeToken
    ...
    attr_accessor :one_time_secret_id
    ...
    def self.attribute_map
      {
        ...
        :'one_time_secret_id' => :'OneTimeSecretID'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NomadClient::OneTimeToken` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NomadClient::OneTimeToken`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'one_time_secret_id')
        self.one_time_secret_id = attributes[:'one_time_secret_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          one_time_secret_id == o.one_time_secret_id
    end
    ...
    def hash
      [accessor_id, create_index, expires_at, modify_index, one_time_secret_id].hash
    end
