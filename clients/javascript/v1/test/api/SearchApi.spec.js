...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.SearchApi();
  });
  ...
  describe('SearchApi', function() {
    describe('getFuzzySearch', function() {
      it('should call getFuzzySearch successfully', function(done) {
        //uncomment below and update the code to test getFuzzySearch
        //instance.getFuzzySearch(function(error) {
