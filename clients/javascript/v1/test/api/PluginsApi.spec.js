...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.PluginsApi();
  });
  ...
  describe('PluginsApi', function() {
    describe('getPluginCSI', function() {
      it('should call getPluginCSI successfully', function(done) {
        //uncomment below and update the code to test getPluginCSI
        //instance.getPluginCSI(function(error) {
