...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.JobVersionsResponse();
  });
  ...
  describe('JobVersionsResponse', function() {
    it('should create an instance of JobVersionsResponse', function() {
      // uncomment below and update the code to test JobVersionsResponse
      //var instane = new nomad-client.JobVersionsResponse();
      //expect(instance).to.be.a(nomad-client.JobVersionsResponse);
    });

    it('should have the property diffs (base name: "Diffs")', function() {
      // uncomment below and update the code to test the property diffs
      //var instance = new nomad-client.JobVersionsResponse();
