...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.ACLPolicyListStub();
  });
  ...
  describe('ACLPolicyListStub', function() {
    it('should create an instance of ACLPolicyListStub', function() {
      // uncomment below and update the code to test ACLPolicyListStub
      //var instane = new nomad-client.ACLPolicyListStub();
      //expect(instance).to.be.a(nomad-client.ACLPolicyListStub);
    });
    ...
    it('should have the property createIndex (base name: "CreateIndex")', function() {
      ...
      //var instance = new nomad-client.ACLPolicyListStub();
