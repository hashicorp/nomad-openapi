...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.JobRegisterResponse();
  });
  ...
  describe('JobRegisterResponse', function() {
    it('should create an instance of JobRegisterResponse', function() {
      // uncomment below and update the code to test JobRegisterResponse
      //var instane = new nomad-client.JobRegisterResponse();
      //expect(instance).to.be.a(nomad-client.JobRegisterResponse);
    });
    ...
    it('should have the property evalCreateIndex (base name: "EvalCreateIndex")', function() {
      ...
      //var instance = new nomad-client.JobRegisterResponse();
