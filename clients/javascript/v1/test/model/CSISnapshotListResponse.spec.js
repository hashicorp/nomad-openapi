...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.CSISnapshotListResponse();
  });
  ...
  describe('CSISnapshotListResponse', function() {
    it('should create an instance of CSISnapshotListResponse', function() {
      // uncomment below and update the code to test CSISnapshotListResponse
      //var instane = new nomad-client.CSISnapshotListResponse();
      //expect(instance).to.be.a(nomad-client.CSISnapshotListResponse);
    });
    ...
    it('should have the property knownLeader (base name: "KnownLeader")', function() {
      ...
      //var instance = new nomad-client.CSISnapshotListResponse();
