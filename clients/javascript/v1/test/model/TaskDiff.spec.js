...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.TaskDiff();
  });
  ...
  describe('TaskDiff', function() {
    it('should create an instance of TaskDiff', function() {
      // uncomment below and update the code to test TaskDiff
      //var instane = new nomad-client.TaskDiff();
      //expect(instance).to.be.a(nomad-client.TaskDiff);
    });
    ...
    it('should have the property annotations (base name: "Annotations")', function() {
      ...
      //var instance = new nomad-client.TaskDiff();
