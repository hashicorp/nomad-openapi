...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.FuzzySearchRequest();
  });
  ...
  describe('FuzzySearchRequest', function() {
    it('should create an instance of FuzzySearchRequest', function() {
      // uncomment below and update the code to test FuzzySearchRequest
      //var instane = new nomad-client.FuzzySearchRequest();
      //expect(instance).to.be.a(nomad-client.FuzzySearchRequest);
    });
    ...
    it('should have the property allowStale (base name: "AllowStale")', function() {
      ...
      //var instance = new nomad-client.FuzzySearchRequest();
