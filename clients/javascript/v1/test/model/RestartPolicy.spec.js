...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.RestartPolicy();
  });
  ...
  describe('RestartPolicy', function() {
    it('should create an instance of RestartPolicy', function() {
      ...
      //var instane = new nomad-client.RestartPolicy();
      //expect(instance).to.be.a(nomad-client.RestartPolicy);
    });
    ...
    it('should have the property attempts (base name: "Attempts")', function() {
      ...
      //var instance = new nomad-client.RestartPolicy();
