...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.AllocDeploymentStatus();
  });
  ...
  describe('AllocDeploymentStatus', function() {
    it('should create an instance of AllocDeploymentStatus', function() {
      // uncomment below and update the code to test AllocDeploymentStatus
      //var instane = new nomad-client.AllocDeploymentStatus();
      //expect(instance).to.be.a(nomad-client.AllocDeploymentStatus);
    });
    ...
    it('should have the property canary (base name: "Canary")', function() {
      ...
      //var instance = new nomad-client.AllocDeploymentStatus();
