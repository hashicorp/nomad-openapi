...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.CSIVolumeCreateRequest();
  });
  ...
  describe('CSIVolumeCreateRequest', function() {
    it('should create an instance of CSIVolumeCreateRequest', function() {
      // uncomment below and update the code to test CSIVolumeCreateRequest
      //var instane = new nomad-client.CSIVolumeCreateRequest();
      //expect(instance).to.be.a(nomad-client.CSIVolumeCreateRequest);
    });
    ...
    it('should have the property namespace (base name: "Namespace")', function() {
      ...
      //var instance = new nomad-client.CSIVolumeCreateRequest();
