...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.CSISnapshotCreateResponse();
  });
  ...
  describe('CSISnapshotCreateResponse', function() {
    it('should create an instance of CSISnapshotCreateResponse', function() {
      // uncomment below and update the code to test CSISnapshotCreateResponse
      //var instane = new nomad-client.CSISnapshotCreateResponse();
      //expect(instance).to.be.a(nomad-client.CSISnapshotCreateResponse);
    });
    ...
    it('should have the property knownLeader (base name: "KnownLeader")', function() {
      ...
      //var instance = new nomad-client.CSISnapshotCreateResponse();
