...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.FieldDiff();
  });
  ...
  describe('FieldDiff', function() {
    it('should create an instance of FieldDiff', function() {
      // uncomment below and update the code to test FieldDiff
      //var instane = new nomad-client.FieldDiff();
      //expect(instance).to.be.a(nomad-client.FieldDiff);
    });
    ...
    it('should have the property annotations (base name: "Annotations")', function() {
      ...
      //var instance = new nomad-client.FieldDiff();
