...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.ACLTokenListStub();
  });
  ...
  describe('ACLTokenListStub', function() {
    it('should create an instance of ACLTokenListStub', function() {
      // uncomment below and update the code to test ACLTokenListStub
      //var instane = new nomad-client.ACLTokenListStub();
      //expect(instance).to.be.a(nomad-client.ACLTokenListStub);
    });
    ...
    it('should have the property accessorID (base name: "AccessorID")', function() {
      ...
      //var instance = new nomad-client.ACLTokenListStub();
