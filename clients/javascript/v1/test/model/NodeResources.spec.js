...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.NodeResources();
  });
  ...
  describe('NodeResources', function() {
    it('should create an instance of NodeResources', function() {
      // uncomment below and update the code to test NodeResources
      //var instane = new nomad-client.NodeResources();
      //expect(instance).to.be.a(nomad-client.NodeResources);
    });

    it('should have the property cpu (base name: "Cpu")', function() {
      // uncomment below and update the code to test the property cpu
      //var instance = new nomad-client.NodeResources();
