...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.JobStabilityRequest();
  });
  ...
  describe('JobStabilityRequest', function() {
    it('should create an instance of JobStabilityRequest', function() {
      // uncomment below and update the code to test JobStabilityRequest
      //var instane = new nomad-client.JobStabilityRequest();
      //expect(instance).to.be.a(nomad-client.JobStabilityRequest);
    });

    it('should have the property jobID (base name: "JobID")', function() {
      // uncomment below and update the code to test the property jobID
      //var instance = new nomad-client.JobStabilityRequest();
