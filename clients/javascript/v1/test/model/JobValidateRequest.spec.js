...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.JobValidateRequest();
  });
  ...
  describe('JobValidateRequest', function() {
    it('should create an instance of JobValidateRequest', function() {
      // uncomment below and update the code to test JobValidateRequest
      //var instane = new nomad-client.JobValidateRequest();
      //expect(instance).to.be.a(nomad-client.JobValidateRequest);
    });

    it('should have the property job (base name: "Job")', function() {
      // uncomment below and update the code to test the property job
      //var instance = new nomad-client.JobValidateRequest();
