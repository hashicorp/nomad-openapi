...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.ACLToken();
  });
  ...
  describe('ACLToken', function() {
    it('should create an instance of ACLToken', function() {
      // uncomment below and update the code to test ACLToken
      //var instane = new nomad-client.ACLToken();
      //expect(instance).to.be.a(nomad-client.ACLToken);
    });
    ...
    it('should have the property accessorID (base name: "AccessorID")', function() {
      ...
      //var instance = new nomad-client.ACLToken();
