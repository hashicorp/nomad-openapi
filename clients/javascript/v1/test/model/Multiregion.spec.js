...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.Multiregion();
  });
  ...
  describe('Multiregion', function() {
    it('should create an instance of Multiregion', function() {
      // uncomment below and update the code to test Multiregion
      //var instane = new nomad-client.Multiregion();
      //expect(instance).to.be.a(nomad-client.Multiregion);
    });
    ...
    it('should have the property regions (base name: "Regions")', function() {
      ...
      //var instance = new nomad-client.Multiregion();
