...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.JobDeregisterResponse();
  });
  ...
  describe('JobDeregisterResponse', function() {
    it('should create an instance of JobDeregisterResponse', function() {
      // uncomment below and update the code to test JobDeregisterResponse
      //var instane = new nomad-client.JobDeregisterResponse();
      //expect(instance).to.be.a(nomad-client.JobDeregisterResponse);
    });
    ...
    it('should have the property evalCreateIndex (base name: "EvalCreateIndex")', function() {
      ...
      //var instance = new nomad-client.JobDeregisterResponse();
