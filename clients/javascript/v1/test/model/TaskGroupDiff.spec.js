...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.TaskGroupDiff();
  });
  ...
  describe('TaskGroupDiff', function() {
    it('should create an instance of TaskGroupDiff', function() {
      // uncomment below and update the code to test TaskGroupDiff
      //var instane = new nomad-client.TaskGroupDiff();
      //expect(instance).to.be.a(nomad-client.TaskGroupDiff);
    });

    it('should have the property fields (base name: "Fields")', function() {
      // uncomment below and update the code to test the property fields
      //var instance = new nomad-client.TaskGroupDiff();
