...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.Namespace();
  });
  ...
  describe('Namespace', function() {
    it('should create an instance of Namespace', function() {
      ...
      //var instane = new nomad-client.Namespace();
      //expect(instance).to.be.a(nomad-client.Namespace);
    });
    ...
    it('should have the property createIndex (base name: "CreateIndex")', function() {
      ...
      //var instance = new nomad-client.Namespace();
