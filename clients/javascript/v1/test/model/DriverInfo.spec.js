...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.DriverInfo();
  });
  ...
  describe('DriverInfo', function() {
    it('should create an instance of DriverInfo', function() {
      // uncomment below and update the code to test DriverInfo
      //var instane = new nomad-client.DriverInfo();
      //expect(instance).to.be.a(nomad-client.DriverInfo);
    });

    it('should have the property attributes (base name: "Attributes")', function() {
      // uncomment below and update the code to test the property attributes
      //var instance = new nomad-client.DriverInfo();
