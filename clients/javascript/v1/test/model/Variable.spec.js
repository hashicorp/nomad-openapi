...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.Variable();
  });
  ...
  describe('Variable', function() {
    it('should create an instance of Variable', function() {
      ...
      //var instane = new nomad-client.Variable();
      //expect(instance).to.be.a(nomad-client.Variable);
    });
    ...
    it('should have the property createIndex (base name: "CreateIndex")', function() {
      ...
      //var instance = new nomad-client.Variable();
