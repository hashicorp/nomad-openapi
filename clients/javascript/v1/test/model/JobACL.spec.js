...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new nomad-client.JobACL();
  });
  ...
  describe('JobACL', function() {
    it('should create an instance of JobACL', function() {
      // uncomment below and update the code to test JobACL
      //var instane = new nomad-client.JobACL();
      //expect(instance).to.be.a(nomad-client.JobACL);
    });

    it('should have the property group (base name: "Group")', function() {
      // uncomment below and update the code to test the property group
      //var instance = new nomad-client.JobACL();
