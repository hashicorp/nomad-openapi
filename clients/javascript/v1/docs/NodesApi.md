...
let apiInstance = new nomad-client.NodesApi();
...
apiInstance.getNode(nodeId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.getNodeAllocations(nodeId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> NodeDrainUpdateResponse updateNodeDrain(nodeId, nodeUpdateDrainRequest, opts)
...
let apiInstance = new nomad-client.NodesApi();
let nodeId = "nodeId_example"; // String | The ID of the node.
let nodeUpdateDrainRequest = new nomad-client.NodeUpdateDrainRequest(); // NodeUpdateDrainRequest | 
let opts = {
  'region': "region_example", // String | Filters results based on the specified region.
  'namespace': "namespace_example", // String | Filters results based on the specified namespace.
  'index': 56, // Number | If set, wait until query exceeds given index. Must be provided with WaitParam.
...
apiInstance.updateNodeDrain(nodeId, nodeUpdateDrainRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> NodeEligibilityUpdateResponse updateNodeEligibility(nodeId, nodeUpdateEligibilityRequest, opts)
...
let apiInstance = new nomad-client.NodesApi();
let nodeId = "nodeId_example"; // String | The ID of the node.
let nodeUpdateEligibilityRequest = new nomad-client.NodeUpdateEligibilityRequest(); // NodeUpdateEligibilityRequest | 
let opts = {
  'region': "region_example", // String | Filters results based on the specified region.
  'namespace': "namespace_example", // String | Filters results based on the specified namespace.
  'index': 56, // Number | If set, wait until query exceeds given index. Must be provided with WaitParam.
...
apiInstance.updateNodeEligibility(nodeId, nodeUpdateEligibilityRequest, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> NodePurgeResponse updateNodePurge(nodeId, opts)
...
apiInstance.updateNodePurge(nodeId, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
