...
let apiInstance = new nomad-client.NamespacesApi();
let opts = {
...
apiInstance.createNamespace(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
> deleteNamespace(namespaceName, opts)
...
let apiInstance = new nomad-client.NamespacesApi();
let namespaceName = "namespaceName_example"; // String | The namespace identifier.
let opts = {
  'region': "region_example", // String | Filters results based on the specified region.
  'namespace': "namespace_example", // String | Filters results based on the specified namespace.
  'xNomadToken': "xNomadToken_example", // String | A Nomad ACL token.
...
apiInstance.deleteNamespace(namespaceName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
> Namespace getNamespace(namespaceName, opts)
...
apiInstance.getNamespace(namespaceName, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
apiInstance.getNamespaces(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> postNamespace(namespaceName, namespace2, opts)
...
let apiInstance = new nomad-client.NamespacesApi();
let namespaceName = "namespaceName_example"; // String | The namespace identifier.
let namespace2 = new nomad-client.Namespace(); // Namespace | 
let opts = {
  'region': "region_example", // String | Filters results based on the specified region.
  'namespace': "namespace_example", // String | Filters results based on the specified namespace.
  'xNomadToken': "xNomadToken_example", // String | A Nomad ACL token.
...
apiInstance.postNamespace(namespaceName, namespace2, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
