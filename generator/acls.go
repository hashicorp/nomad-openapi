...
func (v *v1api) getACLPaths() []*apiPath {
	...
	return []*apiPath{
		...
		//s.mux.HandleFunc("/v1/acl/policy/", s.wrap(s.ACLPolicySpecificRequest))
		{
			...
			Operations: []*operation{
				newOperation(http.MethodGet,
					...
					"GetACLPolicy",
					nil,
					appendParams(defaultQueryOpts, &policyNameParam),
					newResponseConfig(200,
						objectSchema,
						api.ACLPolicy{},
						defaultQueryMeta,
				...
				newOperation(http.MethodPost,
					...
					appendParams(defaultWriteOpts, &policyNameParam),
					newResponseConfig(200,
						objectSchema,
						nil,
						defaultWriteMeta,
		...
		// NOTE: changed to from /v1/acl/token to /v1/acl/token/self
		//s.mux.HandleFunc("/v1/acl/token/self", s.wrap(s.ACLTokenSpecificRequest))
		{
			Template: "/acl/token/self",
			Operations: []*operation{
				newOperation(http.MethodGet,
