...
func (o *DeploymentState) GetRequireProgressBy() time.Time {
	if o == nil || o.RequireProgressBy == nil {
		var ret time.Time
		return ret
	}
...
func (o *DeploymentState) GetRequireProgressByOk() (*time.Time, bool) {
	...
	return o.RequireProgressBy, true
}
...
func (o DeploymentState) MarshalJSON() ([]byte, error) {
	...
	if o.RequireProgressBy != nil {
		toSerialize["RequireProgressBy"] = o.RequireProgressBy
	}
